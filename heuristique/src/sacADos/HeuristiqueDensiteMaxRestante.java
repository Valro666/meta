...
/**
 * heuristique qui considere qu'on peut mettre une fraction d'objet restant avec
 * une densite correspondant à la densite maximale des objets restants
 */
public class HeuristiqueDensiteMaxRestante extends Heuristique {

	/**
	 * pour ne pas avoir besoin de recalculer la densite maximale quand on
	...
	public double estimer(SolutionPartielle solutionAnalysee) {
		...
		// on recalcule le max si la profonndeur traitee a change depuis la
		// derniere evaluation
