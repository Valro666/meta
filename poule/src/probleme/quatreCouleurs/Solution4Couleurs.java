...
public class Solution4Couleurs extends SolutionAbstract {
	 ...
	 * une solution avec une variations sur de couleur aléatoire sur une cases
	 * aléatoire.
	 * 
	 */
	 ...
	 * retourner une solution avec une variations sur de couleur aléatoire sur
	 * n cases aléatoire.
	 * 
	 * @param n
	 *            le nombre de modification
	 */
	...
	public SolutionAbstract retournePerturbation(int n) {
		...
		for (int i = 0; i < n; i++) {
			perturbed.modifieCouleur((int) Math.random() * couleurs.length, (int) Math.random() * 4);
		}
		// TODO a ecrire etudiant
