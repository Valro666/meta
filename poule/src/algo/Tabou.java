...
public class Tabou extends AlgorithmeAbstract {
	...
	public Tabou(ProblemeAbstract probleme, SolutionAbstract solutionInitiale, int maxEvaluations) {
	 ...
	 */
	// public Tabou(ProblemeAbstract probleme, SolutionAbstract
	// solutionInitiale, TabouFiltreAbstract taboue) {
